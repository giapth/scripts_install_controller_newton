...
openstack endpoint create --region RegionOne \
    volume public http://$CTL_EXT_IP:8776/v1/%\(tenant_id\)s
...
openstack endpoint create --region RegionOne \
    volumev2 public http://$CTL_EXT_IP:8776/v2/%\(tenant_id\)s
...
ops_edit $cinder_ctl DEFAULT transport_url rabbit://openstack:$RABBIT_PASS@$CTL_MGNT_IP
